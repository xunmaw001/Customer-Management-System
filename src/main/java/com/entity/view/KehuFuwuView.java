...
*/
@TableName("kehu_fuwu")
public class KehuFuwuView extends KehuFuwuEntity implements Serializable {
	...
	* 客户服务类型的值
	*/
	@ColumnInfo(comment="客户服务类型的字典表值",type="varchar(200)")
	private String kehuFuwuValue;
	/**
	* 状态的值
	*/
	@ColumnInfo(comment="状态的字典表值",type="varchar(200)")
	private String kehuFuwuZhuangtaiValue;
	...
	public KehuFuwuView(KehuFuwuEntity kehuFuwuEntity) {
		try {
			BeanUtils.copyProperties(this, kehuFuwuEntity);
	...
	* 获取： 客户服务类型的值
	*/
	public String getKehuFuwuValue() {
		return kehuFuwuValue;
	}
	/**
	* 设置： 客户服务类型的值
	*/
	public void setKehuFuwuValue(String kehuFuwuValue) {
		this.kehuFuwuValue = kehuFuwuValue;
	}
	//当前表的
	/**
	* 获取： 状态的值
	*/
	public String getKehuFuwuZhuangtaiValue() {
		return kehuFuwuZhuangtaiValue;
	}
	/**
	* 设置： 状态的值
	*/
	public void setKehuFuwuZhuangtaiValue(String kehuFuwuZhuangtaiValue) {
		this.kehuFuwuZhuangtaiValue = kehuFuwuZhuangtaiValue;
	}
	...
	public String toString() {
		return "KehuFuwuView{" +
			", kehuFuwuValue=" + kehuFuwuValue +
			", kehuFuwuZhuangtaiValue=" + kehuFuwuZhuangtaiValue +
