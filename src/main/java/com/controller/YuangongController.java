    ...
    */
    ...
    public R save(@RequestBody YuangongEntity yuangong, HttpServletRequest request){
        ...
        if(yuangongEntity==null){
            ...
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"新增",yuangong.toString());
            return R.ok();
        }else {
...
//            return R.error(511,"永远不会进入");
        if("".equals(yuangong.getYuangongPhoto()) || "null".equals(yuangong.getYuangongPhoto())){
            ...
            List<String> strings = caozuorizhiService.clazzDiff(yuangong, oldYuangongEntity, request,new String[]{"updateTime"});
    ...
    */
    ...
    public R delete(@RequestBody Integer[] ids, HttpServletRequest request){
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"删除",oldYuangongList.toString());
        return R.ok();
    }
...
//                            yuangongEntity.setCreateTime(date);//时间
                        ...
                        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"批量新增",yuangongList.toString());
                        return R.ok();
                    }
                }
            }
    ...
    */
    ...
    public R login(String username, String password, String captcha, HttpServletRequest request) {
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"登录",yuangong.toString());
        return r;
    }
...
//    	ValidatorUtils.validateEntity(user);
        ...
        caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"注册",yuangong.toString());
        return R.ok();
    }
    ...
    public R resetPassword(Integer  id, HttpServletRequest request) {
        ...
        yuangongService.updateById(yuangong);
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"重置密码",yuangong.toString());
        return R.ok();
    }
    ...
    public R resetPass(String username, HttpServletRequest request) {
        ...
        if(yuangong!=null){
            yuangong.setPassword("123456");
            yuangongService.updateById(yuangong);
            caozuorizhiService.insertCaozuorizhi(String.valueOf(request.getSession().getAttribute("role")),TABLE_NAME,String.valueOf(request.getSession().getAttribute("username")),"忘记密码",yuangong.toString());
            return R.ok();
        }else{
