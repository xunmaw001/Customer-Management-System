...
import huanyuan from '@/views/modules/databaseBackup/huanyuan'
    ...
    import kehuFuwu from '@/views/modules/kehuFuwu/list'
    import kehuLiushi from '@/views/modules/kehuLiushi/list'
    ...
    import dictionaryKehuFuwu from '@/views/modules/dictionaryKehuFuwu/list'
    import dictionaryKehuFuwuZhuangtai from '@/views/modules/dictionaryKehuFuwuZhuangtai/list'
    import dictionaryKehuLiushi from '@/views/modules/dictionaryKehuLiushi/list'
...
const routes = [{
    ...
    ,{
        path: '/dictionaryKehuFuwu',
        name: '客户服务类型',
        component: dictionaryKehuFuwu
    }
    ,{
        path: '/dictionaryKehuFuwuZhuangtai',
        name: '状态',
        component: dictionaryKehuFuwuZhuangtai
    }
    ,{
        path: '/dictionaryKehuLiushi',
        name: '客户流失类型',
        component: dictionaryKehuLiushi
    }
    ,{
