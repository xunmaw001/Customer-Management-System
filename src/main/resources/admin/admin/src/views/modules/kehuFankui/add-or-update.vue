    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="kehuId" name="kehuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="客户反馈编号" prop="kehuFankuiUuidNumber">
                       <el-input v-model="ruleForm.kehuFankuiUuidNumber"
                                 placeholder="客户反馈编号" clearable  :readonly="ro.kehuFankuiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="客户反馈编号" prop="kehuFankuiUuidNumber">
                           <el-input v-model="ruleForm.kehuFankuiUuidNumber"
                                     placeholder="客户反馈编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="客户反馈标题" prop="kehuFankuiName">
                       <el-input v-model="ruleForm.kehuFankuiName"
                                 placeholder="客户反馈标题" clearable  :readonly="ro.kehuFankuiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="客户反馈标题" prop="kehuFankuiName">
                           <el-input v-model="ruleForm.kehuFankuiName"
                                     placeholder="客户反馈标题" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.kehuFankuiFile" label="反馈附件" prop="kehuFankuiFile">
                        <file-upload
                                tip="点击上传反馈附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.kehuFankuiFile?$base.url+ruleForm.kehuFankuiFile:''"
                                @change="kehuFankuiFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.kehuFankuiFile" label="反馈附件" prop="kehuFankuiFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.kehuFankuiFile"  >反馈附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="客户反馈类型" prop="kehuFankuiTypes">
                        <el-select v-model="ruleForm.kehuFankuiTypes" :disabled="ro.kehuFankuiTypes" placeholder="请选择客户反馈类型">
                            <el-option
                                v-for="(item,index) in kehuFankuiTypesOptions"
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="客户反馈类型" prop="kehuFankuiValue">
                        <el-input v-model="ruleForm.kehuFankuiValue"
                            placeholder="客户反馈类型" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.fuwuTime"  class="input" label="客户反馈时间" prop="fuwuTime">
                        <el-date-picker
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.fuwuTime" label="客户反馈时间" prop="fuwuTime">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.kehuFankuiContent"  label="客户反馈内容" prop="kehuFankuiContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.kehuFankuiContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.kehuFankuiContent" label="客户反馈内容" prop="kehuFankuiContent">
                            <span v-html="ruleForm.kehuFankuiContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="反馈状态" prop="kehuFankuizhuangtaiTypes">
                        <el-select v-model="ruleForm.kehuFankuizhuangtaiTypes" :disabled="ro.kehuFankuizhuangtaiTypes" placeholder="请选择反馈状态">
                            <el-option
                                v-for="(item,index) in kehuFankuizhuangtaiTypesOptions"
                                v-bind:key="item.codeIndex"
                                :label="item.indexName"
                                :value="item.codeIndex">
                            </el-option>
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="反馈状态" prop="kehuFankuizhuangtaiValue">
                        <el-input v-model="ruleForm.kehuFankuizhuangtaiValue"
                            placeholder="反馈状态" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    kehuId: false,
                    kehuFankuiUuidNumber: true,
                    kehuFankuiName: false,
                    kehuFankuiFile: false,
                    kehuFankuiTypes: false,
                    fuwuTime: false,
                    kehuFankuiContent: false,
                    kehuFankuizhuangtaiTypes: false,
                    insertTime: false,
                },
                ruleForm: {
                    kehuId: '',
                    kehuFankuiUuidNumber: new Date().getTime(),
                    kehuFankuiName: '',
                    kehuFankuiFile: '',
                    kehuFankuiTypes: '',
                    fuwuTime: '',
                    kehuFankuiContent: '',
                    kehuFankuizhuangtaiTypes: '',
                    insertTime: '',
                },
                kehuFankuiTypesOptions : [],
                kehuFankuizhuangtaiTypesOptions : [],
                kehuOptions : [],
                rules: {
                   kehuId: [
                   ...
                   kehuFankuiUuidNumber: [
                              { required: true, message: '客户反馈编号不能为空', trigger: 'blur' },
                          ],
                   kehuFankuiName: [
                              { required: true, message: '客户反馈标题不能为空', trigger: 'blur' },
                          ],
                   kehuFankuiFile: [
                              { required: true, message: '反馈附件不能为空', trigger: 'blur' },
                          ],
                   kehuFankuiTypes: [
                              { required: true, message: '客户反馈类型不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   fuwuTime: [
                              { required: true, message: '客户反馈时间不能为空', trigger: 'blur' },
                          ],
                   kehuFankuiContent: [
                              { required: true, message: '客户反馈内容不能为空', trigger: 'blur' },
                          ],
                   kehuFankuizhuangtaiTypes: [
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=kehu_fankui_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.kehuFankuiTypesOptions = data.data.list;
                    }
                });
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=kehu_fankuizhuangtai_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.kehuFankuizhuangtaiTypesOptions = data.data.list;
                    }
                });
        ...
        methods: {
            ...
            info(id) {
                let _this =this;
                _this.$http({
                    url: `kehuFankui/info/${id}`,
                    method: 'get'
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        _this.ruleForm = data.data;
                        _this.kehuChange(data.data.kehuId)
                        _this.ruleForm.kehuFankuiContent = _this.ruleForm.kehuFankuiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.kehuFankuiContent = this.ruleForm.kehuFankuiContent.replaceAll(this.$base.url,"");
                        this.$http({
                            url:`kehuFankui/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.kehuFankuiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
            ...
            //图片
            kehuFankuiFileUploadChange(fileUrls){
                this.ruleForm.kehuFankuiFile = fileUrls;
                this.addEditUploadStyleChange()
            },
