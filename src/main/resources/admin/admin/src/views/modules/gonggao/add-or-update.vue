        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.gonggaoFile" label="附件" prop="gonggaoFile">
                        <file-upload
                                tip="点击上传附件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.gonggaoFile?$base.url+ruleForm.gonggaoFile:''"
                                @change="gonggaoFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.gonggaoFile" label="附件" prop="gonggaoFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="$base.url+ruleForm.gonggaoFile"  >附件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.gonggaoTime"  class="input" label="公告执行时间" prop="gonggaoTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.gonggaoTime"
                                type="datetime"
                                placeholder="公告执行时间"
                                :disabled="ro.gonggaoTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.gonggaoTime" label="公告执行时间" prop="gonggaoTime">
                            <span v-html="ruleForm.gonggaoTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                rules: {
                   ...
                   gonggaoTime: [
                              { required: true, message: '公告执行时间不能为空', trigger: 'blur' },
                          ],
                   gonggaoContent: [
        ...
        methods: {
            ...
            //图片
            gonggaoFileUploadChange(fileUrls){
                this.ruleForm.gonggaoFile = fileUrls;
                this.addEditUploadStyleChange()
            },
