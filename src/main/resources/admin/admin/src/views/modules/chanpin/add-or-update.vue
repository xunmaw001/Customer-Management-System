    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="产品编号" prop="chanpinUuidNumber">
                       <el-input v-model="ruleForm.chanpinUuidNumber"
                                 placeholder="产品编号" clearable  :readonly="ro.chanpinUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.chanpinPhoto" label="产品照片" prop="chanpinPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.chanpinPhoto?$base.url+ruleForm.chanpinPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="产品原价" prop="chanpinOldMoney">
                       <el-input v-model="ruleForm.chanpinOldMoney"
                                 placeholder="产品原价" clearable  :readonly="ro.chanpinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价" prop="chanpinNewMoney">
                       <el-input v-model="ruleForm.chanpinNewMoney"
                                 placeholder="现价" clearable  :readonly="ro.chanpinNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="现价" prop="chanpinNewMoney">
                           <el-input v-model="ruleForm.chanpinNewMoney"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="所属仓库" prop="chanpinCangku">
                       <el-input v-model="ruleForm.chanpinCangku"
                                 placeholder="所属仓库" clearable  :readonly="ro.chanpinCangku"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.chanpinContent"  label="产品介绍" prop="chanpinContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.chanpinContent" label="产品介绍" prop="chanpinContent">
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    chanpinName: false,
                    chanpinUuidNumber: true,
                    chanpinPhoto: false,
                    chanpinDanwei: false,
                    chanpinTypes: false,
                    chanpinOldMoney: false,
                    chanpinNewMoney: false,
                    chanpinCangku: false,
                ...
                rules: {
                   ...
                   chanpinOldMoney: [
                              { required: true, message: '产品原价不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.chanpinContent = _this.ruleForm.chanpinContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.chanpinContent = this.ruleForm.chanpinContent.replaceAll(this.$base.url,"");
                        this.$http({
